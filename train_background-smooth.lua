...
criterion = nn.ParallelCriterion():add(nn.MSECriterion(),1):add(nn.SmoothAndEdgeTerm(0.1,7,2,0.8,1,0.1,5,0,0),1)
...
postfix = 'smooth_background-smooth'
max_iters = 30
batch_size = 1
...
local file = './smoothing_codes/train_background-smooth.lua'
  ...
  for t = 1,trainsetSize,batch_size do
    ...
    local feval = function(x_new)
      ...
      for i = 1,size do
        ...
        saliency = torch.gt(saliency,0.5)
